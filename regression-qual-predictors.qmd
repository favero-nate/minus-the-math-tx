...
![Distribution of the extroversion trait](Images/regression-qual-predictors/ExtHist.jpg){#fig-ExtHist}
...
If I want to describe differences in extroversion by gender in this dataset, I can compute the mean value of extroversion for males and for females. It turns out that males have an average extroversion of -0.46 while females’ average level of extroversion is 0.53. Thus, the average female is about 1-point more extroverted than the average male. But of course, there is lots of variation in extroversion among both groups, as seen clearly in @fig-GenderExtHist.

![Distribution of extroversion by female/male identity](Images/regression-qual-predictors/GenderExtHist.jpg){#fig-GenderExtHist}
...
I now move beyond the gender binary and consider the “other” category in survey responses. I’ll refer to this other category as “non-binary” gender, although the data was collected at a time when survey items were not generally designed with this group in mind; thus, we might expect that this "other" category is only a rough proxy for a non-binary gender identity. The average level of extroversion among those with non-binary gender is -5.66. So non-binary people tend to be quite a bit more introverted than those who identify as male or female.[^regression-qual-predictors-2] As with males and females, there is still considerable variation among non-binary people (@fig-NonBExtHist).

[^regression-qual-predictors-2]: Or, it may be that extroverts are more willing to select the "other" category on the survey if they do not identify strongly with either male or female.

![Distribution of extroversion trait among those identifying with "other" gender (neither male nor female)](Images/regression-qual-predictors/NonBExtHist.jpg){#fig-NonBExtHist}
