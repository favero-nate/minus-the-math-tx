...
Let’s say I’m interested in studying how personality relates to gender. The most common model of personality in psychology is called the “Big Five." One common measure consists of 50 survey items (the IPIP Big-Five Factor Markers), with 10 items for each of the five personality traits from the model.[^regression-qual-predictors-1] @fig-Big5 shows some of these questions and how they are formatted.

[^regression-qual-predictors-1]: Goldberg, L. R. (1992). The development of markers for the Big-Five factor structure. *Psychological assessment*, *4*(1), 26.
