...
[Click here for the PDF version](Statistics-Minus-The-Math.pdf) of this book.
:::

This book was largely adapted from the public domain resource *Online Statistics Education: A Multimedia Course of Study* (<http://onlinestatbook.com/> Project Leader: David M. Lane, Rice University). A huge thanks to David Lane and his colleagues at Rice University for their creation of this wonderful resource. I use footnotes throughout to indicate precisely where the various sections of each chapter came from. Chapters 11-13 (as well as @sec-interpreting-confidence-intervals-correctly and @sec-quick-guide-to-interpreting-regression-results) were written by me (Nathan).
...
This version (1.3) was updated July 21, 2024. PDFs of past versions are available at <https://minusthemath.com>.

-   Version 1.3 updates: Added material on multiple regression (end of @sec-correlation) and a new @sec-interpreting-confidence-intervals-correctly on interpreting confidence intervals. Notation is updated in line with conventions: regression parameters are redone, and $\bar{X}$ is now used for sample mean and $n$ for sample size. Slight extension of section on the standard normal distribution (@sec-the-standard-normal-distribution). Various formatting updates (book was recreated using Quarto) and minor (non-substantive) edits throughout.
